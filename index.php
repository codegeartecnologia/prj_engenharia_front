        ...
        <header id="header" class="site-header" role="banner">
         <div class="logoacad">
        	<a href="index_login.php">
			    <img id="acadlogo" src="images/logo_acad2.png" alt="ACAD Engenharia" title="Logo ACAD Engenharia e Topografia">
			</a>
       	</div>
	    <div class="container">
		<div class="row"> 
		...
		<ul class="slides">
			...
			<div class="flex-caption section-overlay slide-caption">
				...
				<div class="row">
				    <div class="col-md-12">
					<h2>
					    Esse é um exemplo de slide padrão<br>
					    com legenda

					</h2>
					<a href="#dialog" name="modal" class="slide-button">Ver projeto</a>
				    </div>
				</div>
			    </div>
			</div> 
        ...
        <footer id="footer" class="site-footer" role="contentinfo">
			<div class="container">
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="logoengrenagem">
        				<a href="#">
			    			<img id="gearlogo" src="images/gearlogo.png" alt="CodeGear Tecnologia" title="CodeGear Tecnologia">
						</a>
       				</div>
       				<div>
